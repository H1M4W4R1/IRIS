...
namespace IRIS.Operations.Configuration
{
    ...
    /// </summary>
    public readonly struct DeviceConfigurationInvalidResult : IDeviceOperationResult
    {
        /// <summary>
        ...
        public static implicit operator bool(DeviceConfigurationInvalidResult result) => result.IsSuccess;
    }
}
