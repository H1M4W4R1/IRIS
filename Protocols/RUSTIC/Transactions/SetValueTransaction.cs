...
namespace IRIS.Protocols.RUSTIC.Transactions
{
        ...
        IDataExchangeTransaction<SetValueTransaction, SetValueRequestData, SetValueResponseData>
    {
        ...
        public async Task<SetValueResponseData> _ExchangeAsync<TDevice, TCommunicationInterface>(TDevice device, SetValueRequestData requestData, CancellationToken cancellationToken = default) where TDevice : DeviceBase<TCommunicationInterface> where TCommunicationInterface : ICommunicationInterface
        {
            ...
            await communicationInterface.SendDataAsync<RusticProtocol, SetValueTransaction, SetValueRequestData>(requestData, cancellationToken);
            
            // Read response
            return await communicationInterface.ReceiveDataAsync<RusticProtocol, SetValueTransaction, SetValueResponseData>(cancellationToken);
        }
    }
}