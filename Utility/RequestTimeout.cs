...
namespace IRIS.Utility
{
    ...
    /// <remarks>
    /// When initialized with a value of 0 or less, no timeout will be enforced as the default cancellation token will be used.
    /// This struct provides a convenient way to handle timeouts in async operations through implicit conversion to CancellationToken.
    /// </remarks>
